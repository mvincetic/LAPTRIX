...
| B3 Generic Formula 2026 | Integrated original editable source, native wheel rig, shaped aero surfaces and LAPTRIX livery from public FIA direction. The local gate passes 334 TypeScript / 162 Python and ten assets; four Blender exports reproduce exactly. Eight focused and 26 wider development cases, all 40 production cases, 64 poses, 48 Formula reference and 26 Onboard states pass, plus six native-GPU and three software motion samples. Commit/push and verify this candidate's remote CI. |
| B4 Formal visual checkpoint | Before/after GT and Formula views, environment/vehicle detail and measured resources are retained locally. VISUAL_CHECKPOINT.md records stronger vehicles and speed cues but still-simplified ground/surface presentation. Keep breadth paused; after B3 validation, improve Blender-authored surface materials and road/ground continuity within this same slice before reassessing. |
